...
# function for drawing w on a uniform ball, specifically for APS
from entropy import draw_w
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_timestep", type=int, default=int(1e5) + 1)
    ...
    for t in trange(args.max_timestep):
        ...
        if t < args.start_timestep:
            ...
            action = algo.select_action(np.array(state), w, stochastic=True)
